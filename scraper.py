...
def main():
    ...
    scrape_and_save("https://forecast.weather.gov/MapClick.php?zoneid=ANZ380", 'morichesinletny_noaa.json')   # Moriches Inlet NY to Montauk Point NY, 20-60nm (OKX)
    ...
    scrape_and_save("https://forecast.weather.gov/MapClick.php?zoneid=ANZ350", 'morichesinletny_noaa_nearshore.json')   # Moriches Inlet NY to Montauk Point NY, 0-20nm (OKX)
